...
lady_tops.children.create([{name: "Tシャツ/カットソー(半袖/袖なし)", size: 1},{name: "Tシャツ/カットソー(七分/長袖)", size: 1},{name: "シャツ/ブラウス(半袖/袖なし)", size: 1},{name: "シャツ/ブラウス(七分/長袖)", size: 1},{name: "ポロシャツ", size: 1},{name: "キャミソール", size: 1},{name: "タンクトップ", size: 1},{name: "ホルターネック", size: 1},{name: "ニット/セーター", size: 1},{name: "チュニック", size: 1},{name: "カーディガン/ボレロ", size: 1},{name: "アンサンブル", size: 1},{name: "ベスト/ジレ", size: 1},{name: "パーカー", size: 1},{name: "トレーナー/スウェット", size: 1},{name: "ベアトップ/チューブトップ", size: 1},{name: "ジャージ", size: 1},{name: "その他", size: 1}])

lady_jacket = lady.children.create(name: "ジャケット/アウター")
lady_jacket.children.create([{name: "テーラードジャケット", size: 1},{name: "ノーカラージャケット", size: 1},{name: "Gジャン/デニムジャケット", size: 1},{name: "レザージャケット", size: 1},{name: "ダウンジャケット", size: 1},{name: "ライダースジャケット", size: 1},{name: "ミリタリージャケット", size: 1},{name: "ダウンベスト", size: 1},{name: "ジャンパー/ブルゾン", size: 1},{name: "ポンチョ", size: 1},{name: "ロングコート", size: 1},{name: "トレンチコート", size: 1},{name: "ダッフルコート", size: 1},{name: "ピーコート", size: 1},{name: "チェスターコート", size: 1},{name: "モッズコート", size: 1},{name: "スタジャン", size: 1},{name: "毛皮/ファーコート", size: 1},{name: "スプリングコート", size: 1},{name: "スカジャン", size: 1},{name: "その他", size: 1}])

lady_pants = lady.children.create(name: "パンツ")
lady_pants.children.create([{name: "デニム/ジーンズ", size: 1},{name: "ショートパンツ", size: 1},{name: "カジュアルパンツ", size: 1},{name: "ハーフパンツ", size: 1},{name: "チノパン", size: 1},{name: "ワークパンツ/カーゴパンツ", size: 1},{name: "クロップドパンツ", size: 1},{name: "サロペット/オーバーオール", size: 1},{name: "オールインワン", size: 1},{name: "サルエルパンツ", size: 1},{name: "ガウチョパンツ", size: 1},{name: "その他", size: 1}])

lady_skirt = lady.children.create(name: "スカート")
lady_skirt.children.create([{name: "ミニスカート", size: 1},{name: "ひざ丈スカート", size: 1},{name: "ロングスカート", size: 1},{name: "キュロット", size: 1},{name: "その他", size: 1}])

lady_onepiece = lady.children.create(name: "ワンピース")
lady_onepiece.children.create([{name: "ミニワンピース", size: 1},{name: "ひざ丈ワンピース", size: 1},{name: "ロングワンピース", size: 1},{name: "その他", size: 1}])

lady_shoes = lady.children.create(name: "靴")
lady_shoes.children.create([{name: "ハイヒール/パンプス", size: 2},{name: "ブーツ", size: 2},{name: "サンダル", size: 2},{name: "スニーカー", size: 2},{name: "ミュール", size: 2},{name: "モカシン", size: 2},{name: "ローファー/革靴", size: 2},{name: "フラットシューズ/バレエシューズ", size: 2},{name: "長靴/レインシューズ", size: 2},{name: "その他", size: 2}])
...
kids_baby_girl.children.create([{name: "トップス", size: 3},{name: "アウター", size: 3},{name: "パンツ", size: 3},{name: "スカート", size: 3},{name: "ワンピース", size: 3},{name: "ベビードレス", size: 3},{name: "おくるみ", size: 3},{name: "下着/肌着", size: 3},{name: "パジャマ", size: 3},{name: "ロンパース", size: 3},{name: "その他", size: 3}])

kids_baby_boy = kids.children.create(name: "ベビー服(男の子用)~95cm")
kids_baby_boy.children.create([{name: "トップス", size: 3},{name: "アウター", size: 3},{name: "パンツ", size: 3},{name: "おくるみ", size: 3},{name: "下着/肌着", size: 3},{name: "パジャマ", size: 3},{name: "ロンパース", size: 3},{name: "その他", size: 3}])

kids_baby_both = kids.children.create(name: "ベビー服(男女兼用)~95cm")
kids_baby_both.children.create([{name: "トップス", size: 3},{name: "アウター", size: 3},{name: "パンツ", size: 3},{name: "おくるみ", size: 3},{name: "下着/肌着", size: 3},{name: "パジャマ", size: 3},{name: "ロンパース", size: 3},{name: "その他", size: 3}])

kids_girl = kids.children.create(name: "キッズ服(女の子用)100cm~")
kids_girl.children.create([{name: "コート", size: 3},{name: "ジャケット/上着", size: 3},{name: "トップス(Tシャツ/カットソー)", size: 3},{name: "トップス(トレーナー)", size: 3},{name: "トップス(チュニック)", size: 3},{name: "トップス(タンクトップ)", size: 3},{name: "トップス(その他)", size: 3},{name: "スカート", size: 3},{name: "パンツ", size: 3},{name: "ワンピース", size: 3},{name: "セットアップ", size: 3},{name: "パジャマ", size: 3},{name: "フォーマル/ドレス", size: 3},{name: "和服", size: 3},{name: "浴衣", size: 3},{name: "甚平", size: 3},{name: "水着", size: 3},{name: "その他", size: 3}])

kids_boy = kids.children.create(name: "キッズ服(男の子用)100cm~")
kids_boy.children.create([{name: "コート"},{name: "ジャケット/上着", size: 3},{name: "トップス(Tシャツ/カットソー)", size: 3},{name: "トップス(トレーナー)", size: 3},{name: "トップス(その他)", size: 3},{name: "パンツ", size: 3},{name: "セットアップ", size: 3},{name: "パジャマ", size: 3},{name: "フォーマル/ドレス", size: 3},{name: "和服", size: 3},{name: "浴衣", size: 3},{name: "甚平", size: 3},{name: "水着", size: 3},{name: "その他", size: 3}])

kids_both = kids.children.create(name: "キッズ服(男女兼用)100cm~")
kids_both.children.create([{name: "コート", size: 3},{name: "ジャケット/上着", size: 3},{name: "トップス(Tシャツ/カットソー)", size: 3},{name: "トップス(トレーナー)", size: 3},{name: "トップス(その他)", size: 3},{name: "ボトムス", size: 3},{name: "パジャマ", size: 3},{name: "その他", size: 3}])
...
ShippingMethod.create(method_name: "未定", method_cost: 1)
ShippingMethod.create(method_name: "らくらくメルカリ便", method_cost: 1)
ShippingMethod.create(method_name: "ゆうメール", method_cost: 1)
ShippingMethod.create(method_name: "レターパック", method_cost: 1)
ShippingMethod.create(method_name: "普通郵便(定形外)", method_cost: 1)
ShippingMethod.create(method_name: "クロネコヤマト", method_cost: 1)
ShippingMethod.create(method_name: "ゆうパック", method_cost: 1)
ShippingMethod.create(method_name: "クリックポスト", method_cost: 1)
ShippingMethod.create(method_name: "ゆうパケット", method_cost: 1)
ShippingMethod.create(method_name: "未定", method_cost: 2)
ShippingMethod.create(method_name: "クロネコヤマト", method_cost: 2)
ShippingMethod.create(method_name: "ゆうパック", method_cost: 2)
ShippingMethod.create(method_name: "ゆうメール", method_cost: 2)
