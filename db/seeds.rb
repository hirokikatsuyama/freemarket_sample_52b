...
ShippingMethod.create(method_name: "らくらくメルカリ便", method_cost: 2)
ShippingMethod.create(method_name: "ゆうメール", method_cost: 2)
ShippingMethod.create(method_name: "レターパック", method_cost: 2)
ShippingMethod.create(method_name: "普通郵便(定形外)", method_cost: 2)
ShippingMethod.create(method_name: "クロネコヤマト", method_cost: 2)
ShippingMethod.create(method_name: "ゆうパック", method_cost: 2)
ShippingMethod.create(method_name: "クリックポスト", method_cost: 2)
ShippingMethod.create(method_name: "ゆうパケット", method_cost: 2)
ShippingMethod.create(method_name: "未定", method_cost: 3)
ShippingMethod.create(method_name: "クロネコヤマト", method_cost: 3)
ShippingMethod.create(method_name: "ゆうパック", method_cost: 3)
ShippingMethod.create(method_name: "ゆうメール", method_cost: 3)
